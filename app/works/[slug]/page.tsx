  ...
  return (
    <main className="h-screen w-screen overflow-hidden bg-[#080807] flex flex-col">
      <div className="flex flex-col h-full max-w-[1620px] mx-auto w-full px-6 py-6">
        ...
        <div className="flex-1 min-h-0 flex gap-12 mt-10">
          ...
          <div className="flex-1 flex flex-col justify-between">
            <div>
              ...
              <h1
                className="text-[52px] font-bold leading-none tracking-tight text-white mb-8"
              ...
              <p
                className="text-[17px] leading-[1.7] text-[#c5c2c2] mb-8 max-w-[560px]"
                style={{ fontFamily: "var(--font-space-grotesk)" }}
              >
              ...
              <div className="flex gap-2 flex-wrap">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-[12px] uppercase border border-[rgba(148,148,148,0.35)] px-3 py-1 text-[#999]"
                    style={{ fontFamily: "var(--font-geist-mono)" }}
                  >
                    {tag}
                  </span>
          ...
          <div className="w-[420px] shrink-0 flex flex-col gap-6">
            ...
            <div
              className="flex-1 rounded-[32px] min-h-0"
            ...
            >
              <div className="h-full flex flex-col items-center justify-center gap-4 p-8">
                ...
                />
                <p
                  className="text-[13px] uppercase text-[#888] text-center"
                  style={{ fontFamily: "var(--font-geist-mono)" }}
                >
                  {project.category}
                </p>
            ...
            {project.link && (
              <Link
                ...
                className="cta-btn bg-white text-[#414040] text-center py-4 font-bold text-[14px] tracking-wide uppercase"
