...
export default function Home() {
  return (
    <main className="w-full min-h-[100svh] bg-[#080807] flex flex-col justify-between text-white p-4 md:p-6 lg:p-8 overflow-x-hidden">
      ...
      <section className="w-full shrink-0 flex flex-col lg:flex-row items-end justify-between gap-12 lg:gap-24 relative z-10 w-full max-w-[1620px] mx-auto">
        
        {/* Left: Bio & Stats */}
        <div className="flex-1 w-full flex flex-col justify-end items-start pr-0 lg:pr-8">
          <p
            className="text-[28px] md:text-[32px] md:leading-[1.2] leading-[1.3] text-[#fafaf9] font-medium mb-[48px]"
          ...
          >
            ...
            <span>
              ...
              . I build change-making digital products for B2B founders who
              refuse to be underestimated.
            </span>
          </p>
          <div className="flex flex-col">
            <p
              className="text-[12px] md:text-[14px] uppercase text-[#938F8A] leading-[1.5] lg:leading-[1.8] font-medium"
            ...
            >
              ...
              30+ GLOBALLY RECOGNISED WEB AWARDS, $5M IN PRE-SEED FUNDING, $2M+ IN NEW PROJECT WORK AND LEADS + MORE.
            </p>
          </div>
        </div>

        {/* Right: Projects list */}
        <aside className="w-full lg:w-1/2 flex flex-col shrink-0">
          <h1
          ...
          <div className="w-full flex flex-col border-t border-[rgba(255,255,255,0.15)]">
            {projects.slice(0, 9).map((project) => (
              <Link
                ...
                className="group relative flex flex-row items-center justify-between py-2 px-0 hover:px-4 transition-all duration-300 border-b border-[rgba(255,255,255,0.15)] overflow-hidden"
              >
                ...
                <span
                  className="relative z-10 text-[18px] font-medium tracking-[0.01em] transition-colors duration-300 group-hover:text-black"
                  style={{ fontFamily: "'PP Neue Montreal', var(--font-space-grotesk), sans-serif" }}
                >
                  {project.title}
                </span>
                
                <div className="relative z-10 p-[4px] w-[28px] h-[28px] flex items-center justify-end transition-all duration-300 md:group-hover:-translate-x-2 md:group-hover:-translate-y-2 group-hover:text-black">
